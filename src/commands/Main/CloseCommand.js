...
module.exports = class CloseCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    ClaimTicket.findOne({ ChannelID: message.channel.id }, async (err2001, data2001) => {
                    ...
                    if (data200.ClaimUserID === "") {
                      ...
                      if (data01.Transcript === "Yes") {
                        ...
                        const ticketembed = new MessageEmbed()
                          ...
                          .setTimestamp()
                          .setTitle(`Ticket`)
                          .setDescription(`<@${message.author.id}>, are you sure you want to close this ticket? **yes**. If not, it will cancel the command within 10 seconds.`)
                            ...
                            message.channel.awaitMessages({
                              ...
                              setTimeout(() => {
                                ClaimTicket.findOne({ ChannelID: message.channel.id }, async (err, data) => {
                                  ...
                                  const channelsss = message.channel;
