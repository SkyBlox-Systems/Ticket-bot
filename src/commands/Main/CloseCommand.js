        ...
        message.channel.send(ticketembed).then((m) => {
          message.channel.awaitMessages(response => response.content == "yes", {
            ...
            setTimeout(() => {
              ...
              TranscriptLogs.send(`The transcript for ticket: ${message.channel.name}. The file can be found below or by our server: https://shard1.ticketbots.tk/Tickets/${message.guild.id}/${generators}.html`, { files: [`./src/dashboard/Tickets/${message.guild.id}/${generators}.html`] })

              const guildId = message.guild.id
              const userId = message.member.id
              const DatabaseMessage = (`The transcript for ticket: ${message.channel.name}. The file can be found below or by our server: https://shard1.ticketbots.tk/Tickets/${message.guild.id}/${generators}.html`, { files: [`./src/dashboard/Tickets/${message.guild.id}/${generators}.html`] })
