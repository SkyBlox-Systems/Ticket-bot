              ...
              if (data45) {
                ...
                if (data01.SecondServer === 'Enabled') {
                  ...
                  newguild.channels.create(name).then(async (chan) => {
                    ...
                    const TicketClainCommandSend = newguild.channels.cache.find(ch => ch.id() == data01.SecondServerClaimChannel && ch.type == "GUILD_TEXT")
